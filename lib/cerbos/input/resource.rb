...
module Cerbos
  module Input
    ...
    class Resource
      ...
      # @return [String] a unique identifier for the resource.
      attr_reader :id

      # @return [Attributes] application-specific attributes describing the resource.
      attr_reader :attributes

      # The policy version to use when checking the principal's permissions on the resource.
      #
      # @return [String] the policy version to use when checking the principal's permissions on the resource.
      ...
      #
      # @return [String] the policy scope to use when checking the principal's permissions on the resource.
